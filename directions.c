...
{
	if ((int)(y_coordinate + 1) % 64 == 0 && window->map[(int)(y_coordinate / 64.0) + 1][(int)(x_coordinate / 64.0)] == '0')
	{
...
{
	if ((int)(y_coordinate) % 64 == 0 && window->map[(int)((y_coordinate / 64.0) - 1)][(int)(x_coordinate / 64.0)] == '0')
	{
		window->ray_position = x_coordinate;
		return ('S');
	}
